...
export default function Login() {
  ...
  return (
    <main className="container-page page-shell grid min-h-screen place-items-center py-28">
      <form
        onSubmit={submit}
        className="w-full max-w-md overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-2xl shadow-black/10 dark:border-zinc-800 dark:bg-zinc-900"
      >
          ...
          <label className="block">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-2 text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800"
              >
