...
const trainers = [
  ...
  ['Võ Đức Thanh', 'thanh.pt@ironzone.vn', '0945678901', 'Bodybuilding', 'ISSA-CPT, Sports Nutrition', 450000, 'Runner-up Mr. Vietnam 2022, chuyên tăng cơ giảm mỡ.', 'https://i.pravatar.cc/300?img=15'],
  ['Đỗ Bảo Anh', 'baoanh.pt@ironzone.vn', '0951112233', 'Functional Training', 'TRX, NASM-CES', 330000, 'Thiết kế chương trình functional cho dân văn phòng.', 'https://i.pravatar.cc/300?img=50'],
  ['Hoàng Nam', 'nam.pt@ironzone.vn', '0961112233', 'Calisthenics', 'Street Workout Coach', 320000, 'Tập trung kiểm soát cơ thể, pull-up, handstand và core.', 'https://i.pravatar.cc/300?img=16'],
  ['Bùi Khánh Vy', 'vy.pt@ironzone.vn', '0971112233', 'Dance Fitness', 'Zumba, Les Mills', 270000, 'Lớp nhóm năng lượng cao, thân thiện với người mới.', 'https://i.pravatar.cc/300?img=49'],
  ['Alex Morgan', 'alex.morgan@ironzone.vn', '0982223344', 'Athletic Performance', 'NASM-PES, FMS Level 2', 520000, 'Huấn luyện vận động viên bán chuyên, tối ưu tốc độ, sức bật và sức bền.', 'https://i.pravatar.cc/300?img=33'],
  ['Sophia Bennett', 'sophia.bennett@ironzone.vn', '0982223355', 'Mobility & Recovery', 'RYT-500, Corrective Exercise', 360000, 'Chuyên phục hồi vận động, mobility và cải thiện tư thế.', 'https://i.pravatar.cc/300?img=56'],
  ['Nguyễn Quỳnh Anh', 'quynhanh.pt@ironzone.vn', '0982223366', 'Nutrition Coaching', 'Precision Nutrition L1', 380000, 'Tư vấn dinh dưỡng thực tế, giúp hội viên xây dựng thói quen bền vững.', 'https://i.pravatar.cc/300?img=45'],
  ['Trần Quốc Bảo', 'quocbao.pt@ironzone.vn', '0982223377', 'Powerlifting', 'IPF Club Coach', 480000, 'Chuyên squat, bench press, deadlift và lập trình sức mạnh theo chu kỳ.', 'https://i.pravatar.cc/300?img=18']
];
